...
**Known issues / deferred:** Azure deploy intentionally NOT run (stop condition); scaffold page planet table degraded until T2.5; `backend/scripts/test_chart.py` still imports the deprecated module (standalone script, not a route — retire it with the module).
